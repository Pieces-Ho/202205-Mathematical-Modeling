...
if __name__ == "__main__":
    ...
    v1 = []
    cof = []
    file_path = 'C:\\Users\\MZ Huo\\Desktop\\150mt.txt'
    ...
    plt.title('The line graph of relationship between Coefficient of rolling friction and Initial velocity when 150mT')
